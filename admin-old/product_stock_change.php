...
if(isset($_POST['btnUpdate']))
{
	...
	foreach($pids as $k)
	{
		...
		if($newStock[$k] != '')
		{
			$utility->updateField($k, 'product_id', (int)$newStock[$k], 'product_quantity', 'products','YES','pdate_modified');
		}
	}
...
<title><?php echo COMPANY_S; ?> - Stock Update</title>
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                		<table class="single-column" cellpadding="0" cellspacing="0">
                            ...
                            ?>  
                             ...
                             <thead align="left" class="tableHead">
                              <th width="3%" align="center">#</th>
                              <th width="48%"   align="center">Product Name </th>
                              <th width="12%" >Added On</th>
                              <th width="12%">Ordered</th>
                              <th width="9%">Viewed</th>
                              <th width="9%" >Old Stock </th>
                              <th width="7%" >New Stock </th>
                            </thead>
                            <?php 
...
<?php /*?>                            <div class="lower-block"><?php $page->getPage($numPages, $link, $pageNumber, $pageArray);?></div>
<?php */?>                        </div>
