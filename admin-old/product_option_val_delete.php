...
{	
	...
	$numOptVal	 = $utility->getNoOfEntry($opt_val_id, 'product_option_value_id', 'product_attribute');
	
	
	//defining error variables
	$action		= 'delete_opt_val';
	...
	{
		//delete
		$prodAttr->deleteOptionVal($opt_val_id);
		
		//forward
		$uMesg->showSuccessT('success', $id, 'id', $_SERVER['PHP_SELF'], SUPRODATTR103, 'SUCCESS');
	}
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Option Value</title>
...
<table class="tblBrd" align="center" width="98%">
	...
	?>
	<?php 
    if( (isset($_GET['action'])) && ($_GET['action'] == 'delete_opt_val')  )
    {
        //get option detail
      ...
      <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <span class="bld"><?php echo $optValDetail[0];?> </span>
            </td>
          </tr>
          <tr>
            <td width="105" class="menuText">&nbsp;</td>
            <td width="72%" height="25" align="left">
            <input name="btnDeleteOpt" type="submit" class="buttonYellow" id="btnDeleteOpt" value="delete" />
