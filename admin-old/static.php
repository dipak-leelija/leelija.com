...
<body>
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo $_SERVER['PHP_SELF']."?action=add_static#addStatic"; ?>">
				  		Add New Web Page 
				  		</a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                	<table class="single-column" cellpadding="0" cellspacing="0">
                        ...
                        <thead>
                          ...
                          <th width="13%">Parent + Category</th>
                          <th width="16%">Photo</th>
                          <th width="16%">Video</th>
                        ...
                        <?php 
                           ...
                           $noOfStatic = array_slice($noOfStatic, $start, $limit);
                            foreach($noOfStatic as $k)
                            {
                                ...
                                $staticDtl 	= $stat->getStaticData($k);
								
								//print_r($staticDtl[14]); exit;
                                $catDetail 	= $category->categoryData($staticDtl[0], 'static_categories');
								
                                $bgColor 	= $utility->getRowColor($i);	
								
								//$staIDs	= $utility->getSingleValueByKey($k, 'static_id', 'static_banner_id','static_banner','');
								
								//get all banner ids 
								$allBannerIds	= $stat->getStaticBannerId($k);
								
								//print_r($allBannerIds);
					    ...
					    ?>
                            ...
                            <tr align="left" class="blackLarge" <?php $utility->printRowColor($bgColor);?>>
                              ...
                              <td>
                                ...
                                <?php
									//get the parent name
									$parentName = $stat->getParentPageName($staticDtl[23]);
									if($parentName != '')
									{
										echo '<span class="brand-color">'.$parentName.'</span><br />';
									} 
									echo $catDetail[0];
								 ?>
                              </td>
                              <td>
                                ...
                                if(($staticDtl[4] != '') && ( file_exists("../images/static/".$staticDtl[4])) )
                                {
                                    echo $utility->imageDisplay2('../images/static/', 
                                                $staticDtl[4], 60, 60, 0, 'greyBorder', $staticDtl[5]);
                                }
                                ?>					  </td>
                              <td>
                                <?php 
                                    if( ($staticDtl[10] != '') && ($uCurl->validateURL($staticDtl[10]) == 'FOUND') )
                                    {
                                        echo $uImg->showYoutubeVideo($staticDtl[10], 150, 200);
                                    }
                                 ?>
                              </td>
                              <td>
                              
                                <?php echo $dateUtil->printDate($staticDtl[8]); ?> </td>
                              <td>
                              
                              
                              [ <a href="<?php echo $utility->getForwardURLByURLAndSEOURL($staticDtl[20],$staticDtl[14],'../','content.php'); ?>" 
                               target="_blank">
                             	view
                              </a> ]
                              ...
                              onClick="MM_openBrWindow('static_edit.php?action=edit_static&id=<?php echo $k; ?>','StaticEdit','scrollbars=yes,width=850,height=700')">
                              edit					  </a> ]<?php */?>
                              ...
                              [ 
                                <a href="javascript:void(0)" 
                              onClick="MM_openBrWindow('static_add_sub.php?action=static_add&id=<?php echo $k; ?>','StaticAdd','scrollbars=yes,width=700,height=600')">
                              add more					  </a> ]					  </div>
                              <div class="padT5">
                                ?>[ 
                                <a href="javascript:void(0)" 
                              onClick="MM_openBrWindow('static_add_file.php?action=add_file&id=<?php echo $k; ?>','StaticAddFile','scrollbars=yes,width=800,height=600')">
                              add file					  </a> ]<?php */?>
                              ...
                              [ 
                                <a class="add-file" id="add-file<?php echo $k ?>" href="javascript:void(0)">
                            	 add file
                                </a>  ]
                                
                                
                                [ 
                                <a class="manage-file" id="manage-file<?php echo $k ?>" href="javascript:void(0)">
                            	 manage file
                                </a>  ]
                              </div>
                              <div class="padT5">
                              <?php /*?>[ 
                              <a href="javascript:void(0)"
                              onClick="MM_openBrWindow('static_add_banner.php?action=add_banner&id=<?php echo $k; ?>','StaticAddFile','scrollbars=yes,width=800,height=600')" >
                              add banner
                              </a> ]<?php */?>		
                              [ 
                                <a class="add-banner" id="add-banner<?php echo $k ?>" href="javascript:void(0)">
                            	 add banner
                                </a>  ]		  
                              [ 
                                <a class="manage-banner" id="manage-banner<?php echo $k ?>" href="javascript:void(0)">
                            	 manage banner
                                </a>  ]<br />
                            ...
                            <div id="stat<?php echo $k; ?>" style="position:absolute; display:none; border: 5px solid #65D262; background-color: #FFFFFF; width: 200px; height: auto; padding: 8px; margin-right:50px">
								...
								<?php 
							    	foreach($allBannerIds as $b)
									{
										
										//$allBannerIdsDtl	= $stat->getStaticBannerData($b,$k);
										$allBannerIdsDtl	= $stat->getStaticBanner($b);
										
									    //get all banner id 
									
										//echo $b;
										//get image
										echo '<div class="fl" ><img src="'.URL.'images/static/banner/'.$allBannerIdsDtl[2].'" height="40px" width="125px" /> '.'</div>';
										echo "<div class='marL10 fl' ><a class='iframe' href='static_edit_banner.php?action=edit_banner"."&ban_id=".$b."'>Edit</a></div>";
										echo "<div class='marL10 fl' ><a class='iframe' href='static_banner_delete.php?action=delete_banner&id=".$k."&ban_id=".$b."'>Delete</a></div>";
										echo '<div class="cl"></div>';
										
										echo '<div class="dots marTB10"></div>';
										//get title
										//echo '<br/>'.$allBannerIdsDtl[0]; '<br/>';
									}
								 ?>
                                </div>
                            </div>
                  ...
                  <div class="first-column">
                    ...
                    <div class="pagination-bottom">
                        <div class="upper-block">Total  Web Page(s): <?php echo count($noOfStatic);?></div>
                        <?php echo $pagination ?>
                    </div>
                  <div class="cl"></div>
    ...
    <!-- manage file -->
    <div id="static-file-overlay" class="overlay"></div>
    <div id="divResize" class="dialog static-file-dialog">
    	<div class="file">
    ...
    <!-- add file -->
    <div id="add-file-overlay" class="overlay"></div>
    <div id="addDivResize"class="dialog add-file-dialog">
    	<div class="file">
            <a href="javascript:void()" class="close-popup topCloseBtn" title="Click here to close the popup">
                <img src="../images/icon/close-button.png" />
            </a>
            ...
            <h2>Add Files</h2>
            <div id="add-file-msg"></div>
        	<div id="add-formfile" class="webform-area">
                <span>Please note that all the <span class="required">*</span> marked fileds are required</span>
                <form action="" id="form-add-file" method="post"  enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="static_id" id="static_id" value="<?php  ?>" />
    ...
    <!-- add banner -->
    <div id="add-banner-overlay" class="overlay"></div>
    <div id="addBannerResize" class="dialog add-banner-dialog">
    	<div class="file">
            <a href="javascript:void()" class="close-popup topCloseBtn" title="Click here to close the popup">
                <img src="../images/icon/close-button.png" />
            </a>
            ...
            <h2>Add Banner</h2>
            <div id="add-banner-msg"></div>
        	<div id="add-formbanner" class="webform-area">
                <span>Please note that all the <span class="required">*</span> marked fileds are required</span>
                <form action="" id="form-add-banner" method="post"  enctype="multipart/form-data">
                  ...
                  <div class="cl"></div>
                    ...
                    <label>&nbsp;</label>
                    <input type="hidden" name="banner_static_id" id="banner_static_id" />
    ...
    <!-- manage banner -->
    <div id="manage-banner-overlay" class="overlay"></div>
    <div id="manageBannerResize" class="dialog manage-banner-dialog">
    	<div class="file">
            <a href="javascript:void()" class="close-popup topCloseBtn" title="Click here to close the popup">
                <img src="../images/icon/close-button.png" />
            </a>
