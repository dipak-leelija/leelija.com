...
function getDescRes()
{
	if(request.readyState == 4)
	{
		...
		if(request.status == 200)
		{
			...
			document.getElementById("showServicesFeaturd").innerHTML = xmlResponse;
		}
