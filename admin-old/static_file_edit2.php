...
$id				= $_POST['downId'];
$downDtl			= $stat->getContentDownloadData($id);
...
{
	//edit
	$stat->updateDownloadContent($id, $downDtl[0], $title, $pagePos, $link, $status, $intSort);
    ...
    <div id="data-column">
        <table class="single-column" cellpadding="0" cellspacing="0">
            ...
            <!-- SHOWING ALL CONTENT -->
             ...
             $downloadIds		= $stat->getContentDownloadId($downDtl[0], 'static_id');
            ...
            ?>
                ...
                <tr align="left" class="blackLarge" <?php $utility->printRowColor($bgColor);?>>
                  ...
                  [ 
                    <a href="javascript:void(0)" id="delete-file<?php echo $k ?>" class="delete-file" onClick="deleteFile2('<?php echo $k ?>')" >
                  delete					  </a> ]
