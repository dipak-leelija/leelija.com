...
else
{
	...
	$to 	 = $customerDtl[0][5]." ".$customerDtl[0][6]. "<".$customerDtl[0][2].">";//Himadri <himadri.s.roy@ansysoft.com>
...
<table class="tblBrd" align="center" width="100%">
	...
	<tr>
	  <td height="25" align='left' bgcolor="#EEEEEE">
		  <h3>Verify Account - <?php echo " ".$customerDtl[0][5]." ".$customerDtl[0][6]; ?></h3>
	  </td>
	</tr>
	<tr>
	  <td>
		...
		<table width="545" border="0" class="blackLarge2">
		  <tr class="textlight">
			<td colspan="4" class="textdark pad5">
				<?php 
                if( ($customerDtl[0][16] == '') || ($customerDtl[0][35] == 'N')  )
                {
                    $clsStyle	= "erBlock";
                }
                else
				...
				<div class="padT20 padB20">
					...
					<?php echo $utility->checkString($customerDtl[0][35],"Y"); ?> />   
					...
					<div class="pad5 fl w200">
						...
						class="text_box_large h25" value="<?php echo $customerDtl[0][16];?>" />
					</div>
