...
<title>Banner Edit Successful</title>
...
<div>
      ...
      <!-- Form -->
     <form name ="statBannerEditForm" id ="statBannerEditForm" action="<?php $_SERVER['PHP_SELF']?>" method="post" 
     enctype="multipart/form-data" autocomplete="off">
     
     	<div id="heading-box">
     		<h2>Banner Edit Successful</h2>
     	</div>
        
        <div class="success-block">
            <p>
            	Your banner has been successfully edited.
            </p>
            
         </div>         
         <div>
           <label>&nbsp;</label>
           <input name="btnCancel" type="submit" class="button-cancel" value="close" onclick="parent.$.colorbox.close(); return false;"/>
           <div class="cl"></div>	
       	</div>  
