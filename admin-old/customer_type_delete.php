...
{	
	...
	// echo count($cus).'--'.count($subType);exit;
...
<div class="popup-form">
    ...
    ?>
      ...
      <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
            ...
            <p>Are you sure	that you want to delete the customer type named </p>
            <?php 
				$parentPath = "Category Home ". ">";
            	// echo "<span class=\"orangeLetter fl\">".$typeDetail[1]."<span>";
            	echo "<span class='orangeLetter'>".$typeDetail[1]."<span>";
			?>
            <div class="cl"></div>	
