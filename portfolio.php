...
<head>
    ...
    <meta name="description"
        content="Leelija Work in differnt platform here few web development portfolio, SEO portfolio, Wordpress customization portfolio and web design portfolio" />
    <meta charset="utf-8">
    <meta name="keywords"
        content="portfolio, SEO portfolio, Web Development portfolio, Wordpress customization portfolio, Work portfolio template, best web design portfolio" />
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    <div id="home">
        ...
        <div class="main_service_page pt-4">
            <!--Main div start-->
            <div class="service_page_banner_portfolio projects-animation_on_text text-center banner py-5">
                ...
                <p>We are providing you the best quality online and Business Development services.</p>
            ...
            <div class="service_page_body py-5">
                <!-- service page body start-->
                <div class="container">
                    <!-- container start-->
                    <div class="portfolio-page reveal">
                        <div class="portfolio-top-head">
                            ...
                            <ul class="portfolio-service-details development-portfolio" style="margin-top: 4px;">
                                <li class="portfolio-service-li"><button type="button" name="button"
                                        class="protfolioServiceBtn all-ports portActive">All</button></li>
                                <?php
				...
				?>
                                <li class="portfolio-service-li"><button type="button" name="button"
                                        class="protfolioServiceBtn"> <?php echo $portDetailsById[1];  ?> </button></li>
                                <?php
					}
				}
				 ?>
					...
					<li  class="portfolio-service-li"><button type="button" name="button" class="protfolioServiceBtn"> <?php echo $portDetailsById[1];  ?> </button></li>
		                  <?php		}
                            ...
                            <ul class="portfolio-service-details seo-portfolio">
                                <li><button type="button" name="button" class="protfolioServiceBtn">web design</button>
                                </li>
                                <li><button type="button" name="button" class="protfolioServiceBtn">web
                                        ...
                                        <div class="card single-portfolio">
                                            <a href="<?php echo $portValue['url'];?>">
                                                <img class="portfolio-img port-img "
                                                    src="images/portfolio/<?php echo $portValue['image'];?> " alt="">
                                                <div class="portfolio-single-detls">
                                            </a>
                                            <h3 class="text-uppercase"><a href="<?php echo $portValue['url'];?>">
