                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-9  display-table-cell v-align client_profile_dashboard_right">
                            ...
                            <div class="row justify-content-evenly dashorder_row me-2">
                                <div class="bg-light">
                                    <h3 class="fw-bold text-center py-2">Package Orders:</h3>
                                </div>
                                <?php
                                ...
                                <div class="card pt-2 activeOrderDetails package-orders-box">
                                        ...
                                        <div class="order_data">
                                            ...
                                            <table style="width: 100%;">
                                                    <tr>
                                                        <td>Transection Id</td>
                                                        <td>:</td>
                                                        <td style="word-break: break-word;"><?php echo $pOrder[9];?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Order Status</td>
                                                        <td>:</td>
                                                    ...
                                                    <tr>
                                                        <td>Date</td>
                                                        <td>:</td>
                                                        <td style="word-break: break-word;"><?php echo $pOrder[8];?></td>
                                                    </tr>
                                                </table>
                                        </div>
                                    </a>
