                 	...
                 	<table class="single-column" cellpadding="0" cellspacing="0">
                        ...
                        ?>
                            <tr align="left" <?php $utility->printRowColor($bgColor);?>>
                              ...
                              <td >
                              [ 
                              <a href="javascript:void(0)" onClick="MM_openBrWindow('contact_view.php?action=view_contact&cus_id=<?php echo $k; ?>',
                              'ContactView','scrollbars=yes,width=650,height=550')">
                              view
                              </a> ]
                             
                              [ 
                              <a href="javascript:void(0)" onClick="MM_openBrWindow('contact_delete.php?action=delete_contact&cus_id=<?php echo $k; ?>',
                              'ContactDelete','scrollbars=yes,width=450,height=350')">
                              delete
                              </a> ]
