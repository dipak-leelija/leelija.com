...
if(isset($_POST['btnCreateType'])) 
{
	...
	// echo $parent_id.'--'.$txtCusType.'--'.$parent_id;exit;
	// $duplicate = $customer->duplicateCustomerType($parent_id, $txtCusType, $parent_id, 'customer_type');

	$duplicate = $customer->duplicateCustomerType($parent_id, $txtCusType, 'customer_type');
					  ...
					  <form action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
							...
							<select name="txtParentId" class=" textBoxA" id="txtParentId">
							  ...
							  if(isset($_GET['txtParentId']))
							  {
								...
								$customer->customerTypeDropDown('*', '', '', 'customer_type');
							  }
							...
							<textarea name="txtDesc" cols="70" rows="15" class="textAr" id="txtDesc"><?php $utility->printSess('txtDesc'); ?></textarea>
