	...
	?>
        ...
        enctype="multipart/form-data">
            ...
            if(isset($_SESSION['selCusType'])){
                ...
                $utility->populateDropDown($_GET['selCusType'], 'customer_type_id','cus_type', 'customer_type');
            ...
            <div class="fl marL10">
                ...
                "acc no" <?php echo $utility->checkString($cusDetail[0][35],'N');?> />
            ...
            value="<?php echo $cusDetail[0][11];?>" size="25"></textarea>
            <div class="cl"></div>
           ...
           <label>Profession</label>
            ...
            value="<?php echo $cusDetail[0][15];?>" size="25" />
            <div class="cl"></div>       
            ...
            <input name="txtTown" type="text" class="text_box_large" id="txtTown"
             value="<?php echo $cusDetail[0][27];?>" size="30" />
             <div class="cl"></div>
             
            <label>Province</label>
            <input name="txtState" type="text" class="text_box_large" id="txtState"
            value="<?php echo $cusDetail[0][28];?>" size="30" />
            <div class="cl"></div>
                        ...
                        if($cusDetail[0][30] > 0){
                            if(isset($_SESSION['txtProvinceId']) && ((int)$_SESSION['txtProvinceId'] > 0)){
                                ...
                                $utility->populateDropDown2($_SESSION['txtProvinceId'], 'province_id', 'province_name', 
                                                            'countries_id', $cusDetail[0][30], 'province');
                            }else{
                        ...
                        if($cusDetail[0][28] > 0){
                            if(isset($_SESSION['txtCountyId']) && ((int)$_SESSION['txtCountyId'] > 0)){
                                ...
                                $utility->populateDropDown2($_SESSION['txtCountyId'], 'county_id', 'county_name', 
                                                            'province_id', $cusDetail[0][28], 'county');
                            }else{
                                $utility->populateDropDown2($cusDetail[0][36], 'county_id', 'county_name', 
                                                            'province_id', $cusDetail[0][28], 'county');
                            }
                        }
                        elseif($cusDetail[0][30] > 0){
                            if(isset($_SESSION['txtCountyId']) && ((int)$_SESSION['txtCountyId'] > 0)){
                                
                                $utility->populateDropDown2($_SESSION['txtCountyId'], 'county_id', 'county_name', 
                                                            'countries_id', $cusDetail[0][30], 'county');
                            }else{
                ...
                if($cusDetail[0][36] > 0){
                    if(isset($_SESSION['txtTownId']) && ((int)$_SESSION['txtTownId'] > 0)){
                        $utility->populateDropDown2($_SESSION['txtTownId'], 'town_id', 'town_name', 
                                                    'county_id', $cusDetail[0][36], 'town');
                    } else{
                        // echo "here";
                        $utility->populateDropDown2($cusDetail[0][27], 'town_id', 'town_name', 
                                                    'county_id', $cusDetail[0][36], 'town');
                    }
                }else{
                    if($cusDetail[0][28] > 0){
                        if(isset($_SESSION['txtTownId']) && ((int)$_SESSION['txtTownId'] > 0)){
                            $utility->populateDropDown2($_SESSION['txtTownId'], 'town_id', 'town_name', 
                                                        'province_id', $cusDetail[0][28], 'town');
                        }else{
                            $utility->populateDropDown2($cusDetail[0][27], 'town_id', 'town_name', 
                                                        'province_id', $cusDetail[0][28], 'town');
                        }
                        ...
                        if(isset($_SESSION['txtTownId']) && ((int)$_SESSION['txtTownId'] > 0)){
                            $utility->populateDropDown2($_SESSION['txtTownId'], 'town_id', 'town_name', 
                                                        'countries_id', $cusDetail[0][30], 'town');
                        }else{
                            $utility->populateDropDown2($cusDetail[0][27], 'town_id', 'town_name', 
                                                        'countries_id', $cusDetail[0][30], 'town');
                        }
            ...
            value="<?php echo $cusDetail[0][33];?>"size="30" />
            <div class="cl"></div>
            ...
            "no" <?php echo $utility->checkString($cusDetail[0][13],'N');?> />
