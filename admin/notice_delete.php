...
{	
	...
	//forward
	$uMesg->showSuccessT('success', $id, 'id', $_SERVER['PHP_SELF'], 'Notice has been successfully deleted', 'SUCCESS');
}
?> 
...
<table class="tblBrd" align="center" width="100%">
	...
	?>
	<tr>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Notice </h3></td>
	</tr>
	<tr>
	  <td>
	  <form action="<?php $_SERVER['PHP_SELF']?>?id=<?php echo $id; ?>" method="post">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			Are you sure that you want to delete the Notice
