...
<body>
    ...
    <!-- Header -->
    <div id="header">
        <!-- <img src="<?php //echo "../".LOGO_WITH_PATH; ?>" width="<?php //echo LOGO_WIDTH; ?>" height="<?php// echo LOGO_HEIGHT; ?>"  alt="<?php //echo LOGO_ALT; ?>" id="logo" /> -->
        <img src="../images/logo/logo.png" width="<?php //echo LOGO_WIDTH; ?>" height="<?php echo LOGO_HEIGHT; ?>"  alt="<?php echo LOGO_ALT; ?>" id="logo" />
    </div>
    <!-- eof Header -->
