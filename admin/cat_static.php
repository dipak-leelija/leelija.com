...
$numOrder		= $uNum->genSortOrderNum('N', 0, 'categories_id', 1, 'static_categories');
...
<title><?php echo COMPANY_S; ?> - Static Content Category</title>
            ...
            <div id="admin-body">
                ...
                <?php 
				  ...
				  if(isset($_GET['catId']))
				  {
					 ...
					 .$parentPath.$category->categoryPath($myCatId,'YES','static_categories').
					 "<span>";			 	
				  } 
                ...
                <div id="data-column">
                    ...
                    $parentCat = $category->displayCategory($catId,'static_categories');
                    ...
                    $rootCat   = $category->displayRoot('static_categories');
                    if(count($rootCat) == 0)
                    {
                    ?>
                    ...
                    <thead>
                      ...
                      <th width="31%">Subcategory(ies)</th>
                    ...
                    <?php 
                        ...
                        {
                            $catDetail 	= $category->categoryData($k,'static_categories');
                    ...
                    ?>
                        <tr align="left" <?php $utility->printRowColor($bgColor);?>>
                          ...
                          <td>
                          <?php 
                          if(count($category->displayCategory($k,'static_categories')) > 0)
                          {
                            echo "<a href='".$_SERVER['PHP_SELF']."?catId=".$k."'>Subcategories(".count($category->displayCategory($k,'static_categories')).")</a>";
                          }
                          else
                          {
                            echo "Subcategories(".count($category->displayCategory($k,'static_categories')).")";
                          }
                          ?>
                          ...
                          [ 
                            <a href="#" 
                          onClick="MM_openBrWindow('cat_static_edit.php?action=edit_cat&amp;id=<?php echo $k; ?>','CatEdit','scrollbars=yes,width=700,height=600')">
                          edit					  
                          </a> ]
                          
                          [ 
                          <a href="#" onClick="MM_openBrWindow('cat_static_del.php?action=delete_cat&id=<?php echo $k; ?>','CatDelete','scrollbars=yes,width=450,height=350')">
                          delete</a> 
                          ]
                          <br /><br />
                          <?php 
