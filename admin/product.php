...
{
	$link = '';
	$pids = $product->getAllProdId('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Product Management</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "product_add.php"."?action=add_prod"; ?>">
                            Add New Product
                        </a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo "$"; echo $prodDetail[14]; ?></td>

                      <td align="center">
					 	<?php 
						$imgId		= $product->getDefaultProdImg($x);
						
						if($imgId > 0)
						{
							$imgDtl		= $product->showProdImg($imgId);
							
							if(($imgDtl[2] != '') && ( file_exists("../images/category/products/".$imgDtl[2])) )
							{
								echo $utility->imageDisplay2('../images/category/products/', $imgDtl[2], 50, 50, 0, '', $imgDtl[0]);
	
							}
						}
						?>
                      </td>
					  <td><?php echo $prodDetail[5];  ?></td>
					  <td><?php echo $dateUtil->printDate($prodDetail[11]); ?></td>
					  <td >
					  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('product_edit.php?action=edit_prod&pid=<?php echo $x; ?>','ProdEdit','scrollbars=yes,width=750,height=600')">
					  edit					  </a> ]
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('product_delete.php?action=del_prod&pid=<?php echo $x; ?>','ProdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]<br>
                      [ 
					  <a href="#" onClick="MM_openBrWindow('product_add_image.php?action=add_img&pid=<?php echo $x; ?>','AddImg','scrollbars=yes,width=700,height=600')">
					  Add Image					  </a> ]					  </td>
				    </tr>
                  <?php 
