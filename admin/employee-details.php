...
$response = $Employee->getEmpById($empId);
$response = json_decode($response);
$theEmp = $response->employee;
...
if ($response->status == 1) {
    ...
    $empUpdated     = $theEmp->updated_on;
    $empAdded       = $theEmp->added_on;

    $empAddress1    = $theEmp->address_line1;
    $empAddress2    = $theEmp->address_line2;

    $empCityId      = $theEmp->city;
    $empCity            = $Location->getCityName($empCityId);

    $empStateId     = $theEmp->state;
    $empState           = $Location->getStateName($empStateId);
    
    $empPinCode     = $theEmp->pin;

    $empCountryId   = $theEmp->country;
    $empCountry         = $Location->getCountryName($empCountryId);
    $empAddrUpdate  = $theEmp->address_update;
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="<?= EMP_IMG_PATH.$empImage ?>" alt="profile_image"
                            ...
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab" href="javascript:;"
                                        type="button" role="tab" id="profile-tab" data-bs-target="#profile-tab-pane"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;"
                                        type="button" role="tab" id="setting-tab" data-bs-target="#setting-tab-pane"
                                        aria-controls="setting-tab-pane" aria-selected="false">
                                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 40"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <title>Guidelins</title>
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;"
                                        type="button" role="tab" id="guideline-tab" data-bs-target="#guideline-tab-pane"
                                        aria-controls="guideline-tab-pane" aria-selected="false">
                                        ...
                                        <span class="ms-1">GuideLines</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="tab-content container-fluid py-4">
            ...
            <!-- tab 2 start -->
            <div class="tab-pane fade" id="guideline-tab-pane" role="tabpanel" aria-labelledby="guideline-tab"
                tabindex="0">
                <div class="row">
