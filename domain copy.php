					...
					<div class="row py-lg-5 pt-sm-5">
						<div class="col-lg-6">
							...
							<div class="prod-dtls-sec">
								<div class="prod-dtls-img">
									<a href="">
										<img src="../../images/domains/<?php echo $domainDtl[10];?>" alt="<?php echo $domainDtl[0];?>" class="img-fluid">
									</a>
								</div>
								<div class="py-lg-5">
									<div class="row">
										<div class="col-lg-5" id="AddCart">
											<input type="button" class="cart-btn purple-btn"  onclick="AddToCart(<?php echo $domainDtl[19]; ?>)" value="ADD TO CART" />
										</div>
										<div class="col-lg-5 buy-sec">
											<!--<a href="#" class="buy-Btn purple_opp_btn">BUY NOW</a>-->
											<input type="button" class="cart-btn purple-btn"  onclick="AddToCart(<?php echo $domainDtl[19]; ?>)" value="BUY NOW" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-6">
							<div class="pb-lg-5 single_domain_feature">
								<h2 class="stat-title text-capitalize text-center pb-lg-5"><?php echo $domainDtl[0]; ?></h2>
								<h3>$<?php echo $domainDtl[8];?></h3>
								<h3 class="sub-title"><i class="fa fa-angle-double-right"></i>Url:<a rel="nofollow" href="<?php echo $domainDtl[9];?>" target="_blank"> <?php echo $domainDtl[9];?></a></h3>
								<h3 class="sub-title"><i class="fa fa-angle-double-right"></i>Niche: <?php echo $rownicheDtls[1];?></h3>
								<h3 class="sub-title"><i class="fa fa-angle-double-right"></i>DA: <?php echo $domainDtl[2];?>
								<i class="fa fa-angle-double-right"></i>PA:<?php echo $domainDtl[3];?></h3>
								<h3 class="sub-title"><i class="fa fa-angle-double-right"></i>TF: <?php echo $domainDtl[5];?>
								<i class="fa fa-angle-double-right"></i>CF:<?php echo $domainDtl[4];?></h3>
								<h3 class="sub-title"><i class="fa fa-angle-double-right"></i>Alexa: <?php echo $domainDtl[6];?>
								<i class="fa fa-angle-double-right"></i>Organic Traffic:<?php echo $domainDtl[7];?></h3>
							</div>
							...
							<div id="share-buttons">
								...
								<!-- Facebook -->
								<a href="http://www.facebook.com/sharer.php?u=http://localhost/lija/domain/<?php echo $seo_url;?>" target="_blank">
