                ...
                <div class="container-fluid display-table">
                    <div class="row ">
                        ...
                        <div class="col-lg-9">
                            ...
                            <br />
                            <div id="boardsTable">
                                <table id="examplew" class="table datatable">
                                    <thead>
                                        <tr>
                                            <!--  <th>Sl. No.</th> -->
                                            <th>Domain</th>
								...
								?>
                                        <tr align="left">
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void()" class="close-icon1 fa fa-times"
                                                    style="color:blue"
                                                ...
                                                <a href="javascript:void()" class="close-icon fa fa-times"
                                                    style="color:red" id="showImage-<?php  echo $_SESSION['blog_id'];?>"
                                                    title="Remove this Blog to my Personal list"
                                                    onclick="RemovePersonalList(<?php echo $eachRecord['blog_id']; ?>)">
                                                </a>
