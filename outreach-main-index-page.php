...
<head>
    ...
    <link href="css/outreach-main-index-page.css" rel='stylesheet' type='text/css' />
...
<body data-scrollbar>
    ...
    <section class="managed-link-building-main-banner">
        <div class="container mlb-main-cntainer p-0">
            <div class="row mlb-main-start-row">
                <div class="col-12 col-lg-6 col-md-6  pe-0 ps-lg-0 pe-lg-3">
                    <div class="mlb-wrapping">
                        <h1 class="mlb-starting-main-h1">Give Your Organic Growth a Boost With High-Quality Backlinks</h1>
                        <p class=" mt-3 mb-4 py-0 py-md-2 mlb-starting-main-p">We help global brands to grow their ROI 3x faster with our data-driven strategies and link-building expertise. 
                        </p>
                ...
                <div class="col-12 col-lg-6 col-md-6 ">
                    <div class="mlb-wrapping">
                        <img src="./images/outreach-main-index-banner-png.webp " class="w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
