...
class ImageUtility extends Utility{
	...
	/**
	*	This function will simply upload the given image to the desired path and save into database withe given table details
	*
	*	@param
	...
	*			$imgSavePath	Directory or folder where the images have to store
	...
	*
	*/
	function imgUpdload($fileName, $newName, $imgSavePath, $id, $column_file, $column_id, $table){
		...
		if(move_uploaded_file($file_tmp, $imgSavePath.$file_new_name)){
	...
	*
	*/
	function imgCropResize($fileName, $fileIndex, $newName, $path, $width, $height, $id, $column_file, $column_id, $table){
