            ...
            <div class="d-md-flex align-items-center justify-content-between">
                ...
                <ul class="social-iconsv2 agileinfo mt-md-0 mt-2">
                    ...
                    <li>
                        ...
                        <a class="dark-blue-color" href="mailto:info@leelija.com"><img src="images/icons/gmail.png"
                                style="height:25px;position:relative;top:-2.5px">
                        ...
                        <ul class="navbar-nav text-left">
                            ...
                            <li class="nav-item dropdown mr-3">
                                ...
                                <div class="dropdown-menu text-lg-left text-center" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item nav-link" href="blogger-outreach.php">Blogger outreach</a>
                                    <a class="dropdown-item nav-link" href="white-label-link-building.php">White Label
                                        Link Building</a>
                                    <a class="dropdown-item nav-link" href="managed-link-building.php">Managed Link
                                        Building</a>
                                    <a class="dropdown-item nav-link" href="link-insertion-service.php">Link Insertion
                                        Service</a>
                                    <a class="dropdown-item nav-link" href="cannabis-backlinks.php">Cannabis
                                        Backlinks</a>
                                    <a class="dropdown-item nav-link" href="high-authority-backlinks.php">High Authority
                                        Backlinks</a>
                                        <a class="dropdown-item nav-link" href="casino-backlinks.php">Casino Backlinks</a>
                                        <a class="dropdown-item nav-link" href="country-specific-backlinks.php">Country Specific Backlinks</a>
